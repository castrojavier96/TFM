...
def monos(activos_close,activos_volumen,n_activos,capital_inicial,com, activos_open, dias_reb, etiquetas):
    ...
    for i in range(54,len(activos_close)):
        ...
        if i==54 or (etiquetas.iloc[i,0] != etiquetas.iloc[i-1,0]):#activos_close.index[i].month != activos_close.index[i-1].month:
